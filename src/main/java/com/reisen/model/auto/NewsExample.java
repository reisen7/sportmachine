...
public class NewsExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andContentNotBetween(String value1, String value2) {
		 ...
		 public Criteria andLikeQuery(News record) {
			...
			if(record.getIntroduction()!=null&&StrUtil.isNotEmpty(record.getIntroduction().toString())) {
    			 list.add("ifnull(introduction,'')");
    		}
			...
			if(record.getIntroduction()!=null&&StrUtil.isNotEmpty(record.getIntroduction().toString())) {
    			list2.add("'%"+record.getIntroduction()+"%'");
    		}
			if(record.getPicture()!=null&&StrUtil.isNotEmpty(record.getPicture().toString())) {
