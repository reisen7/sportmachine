...
import com.reisen.mapper.auto.SysNoticeMapper;
...
import com.reisen.model.auto.SysNoticeUserExample.Criteria;
	 ...
	 */
	 public PageInfo<SysNotice> list(TsysUser tsysUser,Tablepar tablepar,String name){
			...
			if(noticeUsers!=null&&noticeUsers.size()>0) {
		        ...
		        com.reisen.model.auto.SysNoticeExample.Criteria criteria1= testExample.createCriteria();
		        if(name!=null&&!"".equals(name)){
